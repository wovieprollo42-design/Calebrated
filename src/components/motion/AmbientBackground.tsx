...
export function AmbientBackground({ className, intensity = 'high', scrim = 0 }: AmbientBackgroundProps) {
  ...
  return (
    <div aria-hidden="true" className={cn('pointer-events-none absolute inset-0 overflow-hidden', className)}>
      <div className="absolute inset-0" style={{ background: 'linear-gradient(180deg, #0F131B 0%, #161B25 100%)' }} />
      ...
      <div
        ...
        style={{
          background: `radial-gradient(circle, rgba(255,84,0,${strong ? 0.28 : 0.16}) 0%, rgba(255,84,0,0) 65%)`,
        }}
      />
      <div
        ...
        style={{
          background: `radial-gradient(circle, rgba(255,140,0,${strong ? 0.16 : 0.1}) 0%, rgba(255,140,0,0) 65%)`,
        }}
      />
      <div
        ...
        style={{
          animationDelay: '-12s',
          background: 'radial-gradient(circle, rgba(40,48,54,0.9) 0%, rgba(40,48,54,0) 65%)',
        }}
      />
      ...
      {scrim > 0 && <div className="absolute inset-0" style={{ background: `rgba(15,19,27,${scrim})` }} />}
    </div>
  )
}
