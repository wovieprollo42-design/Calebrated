...
export function AmbientBackground({ className, intensity = 'high', scrim = 0 }: AmbientBackgroundProps) {
  ...
  return (
    <div aria-hidden="true" className={cn('pointer-events-none absolute inset-0 overflow-hidden', className)}>
      ...
      <div
        className="absolute -right-[10%] -top-[20%] h-[60vmax] w-[60vmax] rounded-full blur-[110px] animate-drift"
        style={{
          background: `radial-gradient(circle, rgba(255,90,0,${strong ? 0.28 : 0.16}) 0%, rgba(255,90,0,0) 65%)`,
        }}
      />
      <div
        className="absolute -bottom-[25%] -left-[15%] h-[55vmax] w-[55vmax] rounded-full blur-[120px] animate-drift-slow"
        style={{
          background: `radial-gradient(circle, rgba(255,157,0,${strong ? 0.16 : 0.1}) 0%, rgba(255,157,0,0) 65%)`,
        }}
      />
      <div
        className="absolute left-[35%] top-[30%] h-[40vmax] w-[40vmax] rounded-full blur-[130px] animate-drift"
        style={{
          animationDelay: '-12s',
